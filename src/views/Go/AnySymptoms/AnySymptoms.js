...
const AnySymptoms = (props) => {
  const { submitLoading, nextStep, backTab, setDisplayError } = props;
    ...
    <div className={classes.content} >
      <div className={classes.contentBody}>
        <Typography className={classes.title}>
          Are you experiencing <br /> any COVID-19 symptoms?
        </Typography>
        <br />
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', margin: '50px auto 50px', padding:'0 16px' }}>
            <Button
