...
const ReviewInsurance = (props) => {
  const { patient, nextStep, backTab } = props;
    ...
    <div className={classes.content} >
      <div className={classes.contentBody}>
        <Typography className={classes.title}>
          {t('insurance_review_heading')}
        </Typography>
        <Typography className={classes.description}>
          <Trans
            i18nKey="insurance_review_heading_sub"
          ...
          <div className={classes.uploadContanier}>
            ...
            {patient && patient.insurance && patient.insurance.primary_insurance_card_front && (
              <>
                ...
                <Typography className={classes.uploadDesc}>{t('insurance_review_front_label')}</Typography>
              </>
            )}
          ...
          <div className={classes.uploadContanier}>
            ...
            {patient && patient.insurance && patient.insurance.primary_insurance_card_back && (
              <>
                ...
                <Typography className={classes.uploadDesc}>{t('insurance_review_back_label')}</Typography>
              </>
            )}
            <div className={classes.uploadImageContainer}>
