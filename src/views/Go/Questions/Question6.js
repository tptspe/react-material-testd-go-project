          ...
          <div className={classes.boxContainer}>
            ...
            {!first_name_hide &&
              <TextField
                ...
                value={formState.first_name || ''}
                fullWidth
                required={first_name_required || contact_information_required}
            ...
            {!last_name_hide &&
              <TextField
                ...
                fullWidth
                required={last_name_required || contact_information_required}
                InputProps={{ classes: { root: classes.inputLabel } }}
                inputProps={inputRegex}
                InputLabelProps={{ shrink: true }}
                variant="outlined"
            ...
            >
              <FormControl
                variant="outlined"
                required={contact_information_required}
